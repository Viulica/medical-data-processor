"""Run extraction + CPT + ICD on eap-psc zip via local backend."""
import json, os, ssl, time, urllib.request, uuid

BACKEND = "http://localhost:8001"
ZIP = os.path.expanduser("~/Downloads/eap psc split 3 batches.zip")
OUT = "eap-psc_result.xlsx"
