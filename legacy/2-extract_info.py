...
def extract_info_from_single_page(client, page_pdf_path, page_number, extraction_prompt, model="gemini-flash-latest"):
    ...
    try:
        ...
        # Use thinking_budget=-1 for all models
...
def extract_info_from_single_page_with_order(client, page_pdf_path, page_number, extraction_prompt, model="gemini-flash-latest", max_retries=5):
