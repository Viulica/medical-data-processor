...
11. CRITICAL ICD2/ICD3/ICD4 SECONDARY DIAGNOSIS RULES:
   ...
   - DO USE these common comorbidities as ICD2/3/4 when they appear in the medical history, problem list, or review of systems (even in red/highlighted text): I10 (hypertension), E11.9 (diabetes), G47.33 (sleep apnea), I25.10 (CAD), E78.5 (hyperlipidemia), F41.8 (mixed anxiety/depression), J44.9 (COPD). Don't leave ICD2/3/4 empty if the patient has documented comorbidities.
