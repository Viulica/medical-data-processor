...
def get_output_columns():
    """
    Returns the exact column order for the output CSV based on the specified field ordering.
    AI Instructions Part is kept at the beginning as it's required for the conversion process.
    """
    return [
        "AI Instructions Part",  # Keep at beginning - not in ordering list but required
        # Ordered according to provided specification
        "Charge Date",
        "Patient Last Name",
        "Patient First Name",
        "Patient Middle Name",
