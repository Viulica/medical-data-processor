<template>
 ...
 class="tab-btn"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg> Standard
 </button>
<button
 ...
 "
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> Extract + CPT + ICD
 </button>
 <button
 ...
 "
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg> Results
 </button>
<button
 ...
 class="tab-btn"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="18" y1="2" x2="22" y2="6"/><path d="M7.5 20.5L19 9l-4-4L3.5 16.5 2 22z"/></svg> Split PDF
 </button>
 <button
 ...
 class="tab-btn"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg> Manual Split PDF
 </button>
 <button
 @click="activeTab = 'cpt'"
 ...
 class="tab-btn"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg> UNI CPT Codes
 </button>
<button
 ...
 class="tab-btn"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg> Modifiers + Blocks
 </button>
 <button
 ...
 class="tab-btn"
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg> Sorting
 </button>
 ...
 >
 <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg> Helper Tabs
 ...
 <h3 style="color: white"> Configure Processing Steps</h3>
 </div>
 <div class="settings-content">
...
<!-- Excel File Upload -->
 ...
 <p class="info-text">
 File must contain: <strong> Primary Company Name</strong>,
 ...
 <div class="field-info">
 <p class="info-text">
 Optional: Provide special case overrides. Format:
 ...
 <p class="format-note">
 File must have columns: <strong> InputValue</strong> and
 ...
 <li>Skipped: {{ insuranceBulkImportResult.skipped }}</li>
...
Johnson, Robert, MD (MedNet Code: 1)"
 ...
 {{ chargeFieldsResult.fields_overridden }} existing field(s) were overridden with new definitions.
 </p>
 <button
 ...
 The existing peripheral_blocks field was overridden with the new description.
 </p>
 <button
 ...
 {{ colonoscopyFieldsResult.fields_overridden }} existing field(s) were overridden with new definitions.
 </p>
 <button
 ...
 <div class="modal-content modal-large" @click.stop>
 <div class="modal-header">
 <h3> Edit Instruction Template</h3>
 <button
 @click="closePredictionInstructionModals"
 class="close-btn"
 >
...
export default {
 ...
 console.log("Enable Medical Direction:", this.enableMedicalDirection);
 console.log("Enable QK Duplicate:", this.enableQkDuplicate);
 console.log("Limit Anesthesia Time:", this.limitAnesthesiaTime);
 console.log(
